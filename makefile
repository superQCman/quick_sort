...
BENCHMARK_ROOT=$(SIMULATOR_ROOT)/benchmark/quick_sort
...
# C/C++ Source files
QUICK_SORT_SRCS= quick_sort.cpp 
...
all: bin_dir obj_dir quick_sort
...
clean:
	...
	rm -rf proc_r*_t* *.log sim* *.log
clean_all: clean
	rm -rf obj bin

run:
	../../snipersim/run-sniper ./bin/quick_sort > quick_sort.log 2>&1